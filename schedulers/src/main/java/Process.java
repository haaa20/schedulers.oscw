...
public abstract class Process implements Comparable<Process> {
  ...
  public int getWaitingTime() {
    // The time a process has to wait before it reaches the processor
  ...
  public int getTurnaroundTime() {
    // The time a process has to wait before it is COMPLETED
  ...
  public int getResponseTime() {
    // The time elapsed between the process starting and terminating
    // This is different for cpuTime as it includes the time, as it includes the time the process spent waiting after
    // being blocked
    // ... so it could also be defined as cpuTime + blockedTime...?
